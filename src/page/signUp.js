            ...
            <div className="main-page back black">
                <div className="container-size">
                    <div className="container weather-form justify-content-center">
                        ...
                        <input className={errors.confirmpassword ? "is-invalid" : ""} name="confirmpassword" placeholder="confirmpassword" onChange={this.handleChange.bind(this)} />
                        <span className="m-0" >{errors["confirmpassword"]}</span>
